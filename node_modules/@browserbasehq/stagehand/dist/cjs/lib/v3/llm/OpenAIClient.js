...
class OpenAIClient extends LLMClient_js_1.LLMClient {
    type = "openai";
    client;
    ...
    async createChatCompletion({ options: optionsInitial, logger, retries = 3, }) {
        ...
        if (this.modelName.startsWith("o1") || this.modelName.startsWith("o3")) {
            ...
            if (options.tools && options.response_model) {
                throw new sdkErrors_js_1.StagehandError("Cannot use both tool and response_model for o1 models");
            }
            if (options.tools) {
                // Remove unsupported options
        ...
        if (options.temperature &&
            ...
            throw new sdkErrors_js_1.StagehandError("Temperature is not supported for o1 models");
        }
          ...
          Do not include any other text, formatting or markdown in your output. Do not include \`\`\` or \`\`\`json in your response. Only the JSON object itself.`,
                ...
                responseFormat = {
                    ...
                    json_schema: {
                        ...
                        schema: (0, zodCompat_js_1.toJsonSchema)(options.response_model.schema),
                        strict: true,
                    },
                };
            }
        ...
        if (options.response_model) {
            ...
            try {
                (0, utils_js_1.validateZodSchema)(options.response_model.schema, parsedData);
            }
            catch (e) {
                logger({
                    category: "openai",
                ...
                if (e instanceof sdkErrors_js_1.ZodSchemaValidationError) {
                    logger({
                        category: "openai",
                    ...
                    throw new sdkErrors_js_1.CreateChatCompletionResponseError(e.message);
                }
                throw e;
            }
            return {
