...
let V3 = (() => {
    ...
    return class V3 {
        ...
        async prepareAgentExecution(options, instructionOrOptions, agentConfigSignature) {
            ...
            const handler = new v3AgentHandler_js_1.V3AgentHandler(this, this.logger, agentLlmClient, resolvedExecutionModel, options?.systemPrompt, tools, resolvedMode, this.isCaptchaAutoSolveEnabled);
